...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    Alien player2 = new Alien("Crawler",39.653177,-104.825191,2,"ET","Humans R Tasty",39.653177,-105.053244);
    ...
    while(environment1.active){
    	...
    	player2.setPlayerAlienLon(0.0); //!!! simulated '+' change would be set by android sensor
    	...
    	int winner = environment1.gameWinnerCheck(1,2,39.791087,-104.825191,alienPlayerLat,alienPlayerLon);
    	if(winner != -1){
